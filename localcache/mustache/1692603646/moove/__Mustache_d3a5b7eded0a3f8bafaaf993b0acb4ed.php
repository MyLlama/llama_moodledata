...
class __Mustache_d3a5b7eded0a3f8bafaaf993b0acb4ed extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD7abdb117c3cec842db8c732d825f8fa($context, $indent, $value);
        $value = $context->find('settingsselector');
        if (empty($value)) {
...
';
    ...
    private function sectionD7abdb117c3cec842db8c732d825f8fa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
